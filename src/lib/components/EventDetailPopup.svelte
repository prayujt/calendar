<script lang="ts">
  ...
  import { calendars, editingEventDetails, events, selectedEvent, selectedPosition, showEventDetails } from '$lib/stores';
                  ...
                  <div class="ml-auto">
                      <div class="flex gap-x-2">
                          <button
                            ...
                            on:click={() => editingEventDetails.set(true)}
                          >
    ...
    {:else}
        <div class="flex flex-col h-full">
            <div class="flex flex-col mt-2">
                ...
                />
                <textarea
                  class="border-b border-gray-300 p-1 w-full mt-2"
                ...
                <input
                  ...
                  bind:value={$selectedEvent.duration}
                />
            </div>
            <div class="flex items-center ml-auto mt-auto">
                <div
            ...
            <div class="flex mt-2">
                <button
                  class="rounded-full p-1 bg-blue-500 text-white ml-auto mt-2"
                  on:click={() => editingEventDetails.set(false)}
                >
                    Save
                </button>
            </div>
